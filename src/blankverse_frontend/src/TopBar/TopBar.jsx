...
import "./TopBar.css";
import { blankverse_backend } from "../../../declarations/blankverse_backend";
...
export default function TopBar(props) {
  ...
  useEffect(() => {
    const getDocName = async () => {
      const dn = await blankverse_backend.getDocName(documentId);
      props.setDocName(dn);
    };
  ...
  const saveDocName = async () => {
    ...
    await blankverse_backend.updateDocName(documentId, props.docName);
  };
